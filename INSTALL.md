...
3. Modificar este nuevo archivo con los datos correspondientes:
  ...
  4s. ILUSTRACIONES_CSV: url absoluta del archivo csv que alimenta las ilustraciones de compromisos. (Si no se tiene aún, dejar los de ejemplo). `https://recursos-data.buenosaires.gob.ar/ckan2/compromisos/ilustraciones_compromisos.csv`
