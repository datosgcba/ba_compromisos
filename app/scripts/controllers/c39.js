...
angular.module('compromisosSiteApp')
  .controller('Compromiso39Ctrl', function(UrlService, $rootScope, $scope, $http, SlugColorService, LoadSVGService, $sce,$templateRequest,$compile) {
    ...
    $http.jsonp(url)
      .success(function(data) {
        $scope.currentCompromise = $scope.data = _.find(data, function(d) {
          return parseInt(d.numero) === 39;
        });
