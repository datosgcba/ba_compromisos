...
angular.module('compromisosSiteApp')
  .controller('Compromiso28Ctrl', function (UrlService,$compile,$templateRequest, $scope, $http,SlugColorService,LoadSVGService, $sce) {
        ...
        .each(function(d,i){
          ...
          group
            ...
            .on("click", function(d){
                ...
                var templateUrl = $sce.getTrustedResourceUrl('views/includes/pymesDetail.html');
