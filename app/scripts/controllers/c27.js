...
angular.module('compromisosSiteApp')
  .controller('Compromiso27Ctrl', function (UrlService,$compile,$templateRequest, $scope, $http,SlugColorService,LoadSVGService, $sce) {
    ...
    .success(function(data){
      $scope.currentCompromise = $scope.data = _.find(data, function(d){ return parseInt(d.numero) === 27; });
        ...
        .each(function(d,i){
          ...
          group
            ...
            .on("click", function(d){
                ...
                var templateUrl = $sce.getTrustedResourceUrl('views/includes/ledDetail.html');
    ...
    $scope.completeConfig2 = function(config){
      return angular.merge(config,{
        data:{
          type: 'bar',
          keys: {
              value: ['mwh_sobre_anio','toneladas_co2'],
              x: 'anio'
          },
          names: {
            mwh_sobre_anio: 'Megawats por Año',
            toneladas_co2: 'Toneladas CO2'
          },
          colors: {'mwh_sobre_anio':$scope.currentCompromise.secondColor,
                    'toneladas_co2': $scope.currentCompromise.color}
        },
        size: {
            height: 300,
        },
