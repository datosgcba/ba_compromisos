...
angular.module('compromisosSiteApp')
  .controller('Compromiso31Ctrl', function (UrlService,$rootScope, $compile,$templateRequest, $scope, $http,SlugColorService,LoadSVGService, $sce) {
    ...
    .success(function(data){
      $scope.currentCompromise = $scope.data = _.find(data, function(d){ return parseInt(d.numero) === 31; });
      ...
      return angular.merge(config,{
        data:{
          ...
          colors: {
            ...
            'nuevos_metros_peatonalizados':$scope.currentCompromise.color}
        },
        size: {
            height: 300,
        },
