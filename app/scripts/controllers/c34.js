...
angular.module('compromisosSiteApp')
  .controller('Compromiso34Ctrl', function (UrlService,$compile,$templateRequest, $scope, $http,SlugColorService,LoadSVGService, $sce) {
    ...
    .success(function(data){
      $scope.currentCompromise = $scope.data = _.find(data, function(d){ return parseInt(d.numero) === 34; });
        ...
        .each(function(d,i){
          ...
          group
            ...
            .on("click", function(d){
                ...
                var templateUrl = $sce.getTrustedResourceUrl('views/includes/pasosDetail.html');
