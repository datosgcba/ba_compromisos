    ...
    return {
        ...
        controller: ['$scope', '$sce', function($scope, $sce) {
            ...
            if (link !== undefined) {
                ...
                var playauto, autohide, ccloadpolicy, color, controls, disablekb, end, fs, hl, ivloadpolicy, playlist, playsinline, rel, showinfo, start, theme, width, height;

                // Parameter flags to enable/disable youtube parameters
                $scope.playauto === 'true' ? playauto = 1 : playauto = 0; // playauto parameter
                ...
                var iframe = '<iframe width='+width+' height='+height+' src="https://www.youtube.com/embed/' + ytId + '?autoplay=' + playauto + '&autohide=' + autohide + '&cc_load_policy=' + ccloadpolicy + '&color=' + color + '&controls=' + controls + '&disablekb=' + disablekb + '&end=' + end + '&fs=' + fs + '&hl=' + hl + '&playlist=' + playlist + '&playsinline=' + playsinline + '&rel=' + rel + '&showinfo=' + showinfo + '&start=' + start + '&theme=' + theme + '" frameborder="0" allowfullscreen></iframe>';
